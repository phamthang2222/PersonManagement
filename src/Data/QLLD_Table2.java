 ...
 */
public class QLLD_Table2 extends AbstractTableModel{
    private String Name[] = {"Họ tên","Năm sinh ","Giới tính" ,"Vị trí","SĐT","Đội"};
    
    private Class classess[]  = {String.class,String.class,String.class,String.class,String.class,String.class};
    
    ArrayList<NhanVien> dsNhanVien = new ArrayList<NhanVien>();
    
    public QLLD_Table2(ArrayList<NhanVien> nv){
        dsNhanVien = nv;
    }
    @Override
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch(columnIndex){
            ...
            case 5: return dsNhanVien.get(rowIndex).getDoiVS();
